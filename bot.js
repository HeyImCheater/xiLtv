...
//by ,$ ReBeL ء , ??#4777 'CODES SERVER'
		...
		return undefined;
	} else if (command === `stop`) {//by ,$ So.L ء , ??#4777 'CODES SERVER'
		if (!msg.member.voiceChannel) return msg.channel.send('أنت لست بروم صوتي .');
		...
		serverQueue.volume = args[1];//by ,$ So.L ء , ??#4777 'CODES SERVER'
