...
client.user.setGame(` *help | xLiTv Community✨ `,"https://www.twitch.tv/S-F")
  console.log('')
  console.log('')
  console.log('╔[═════════════════════════════════════════════════════════════════]╗')
...
client.on('message', msg => {
  ...
  let args = msg.content.split(" ").slice(1);
    ...
    if(command === "clear") {
        const emoji
		= client.emojis.find("name", "wastebasket")
...
client.on('message', message => {
        ...
        .setURL(`أذا وصصل السسسيرفر 100 عضو :heart:`)        
     message.channel.sendEmbed(embed);
       }
   });
  ...
  client.on('message', message => {
    ...
    var omar;
      if(mentionned){
        ...
        .setFooter(', ♔ ❝ Ｓｏ﹒Ｌ#1022 .',client.user.avatarURL) 
      message.channel.sendEmbed(embed);
    }
});
...
client.on('message', message => {
  ...
  .setAuthor(message.author.username)
  .setColor("#9B59B6")
  .addField(" ** :gear: Server Support :gear: **" , "  **Coming SoOoN**")
